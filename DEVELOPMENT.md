...
```bash
git remote add encore encore://creator-landing-page-app-mtui
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/creator-landing-page-app-mtui/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/creator-landing-page-app-mtui/settings/integrations/github)
